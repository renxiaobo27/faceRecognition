...
def alignMain_xiaobo(args,align,absfilename,filename):
    print 'output folder  ' + args.outputDir
    mkdirP(args.outputDir)

    #imgs = list(iterImgs(args.inputDir))

    #only process query image
    img = Image('',filename,absfilename)
    imgs = []
    imgs.append(img)
...
def align_face_fun():
    ...
    parser.add_argument('--inputDir', type=str, help="Input image directory.",default = '/home/att/PycharmProjects/untitled/mxnet-face/testImg/')
